...
class BwTrialComic {
  ...
  getInfo() {
    ...
    fetch("https://viewer-trial.bookwalker.jp/trial-page/c?cid=" + cId + "&BID=" + bid, {
      "headers": {
        "accept": "*/*",
      ...
      let data =
        fetch(r.url + "configuration_pack.json?" + data, {
          "headers": {
            "accept": "*/*",
            "accept-language": "zh-CN,zh;q=0.9",
            "cache-control": "no-cache",
          ...
          r.configuration.content.forEach(element => {
            this.imageList.push("https://viewer-epubs-trial.bookwalker.jp/0_normal/epid/1" + element.file + "/0." + element.type + "?" + data)
          });
