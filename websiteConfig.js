...
},
{
  ...
  url: 'https://play.dlsite.com/viewer/*',
  originUrl: 'dlsite.com',
  regex: /^https:\/\/play\.dlsite\.com\/viewer\/.*/,
  name: "DLsite コミック",
  supportMsg: [],
  loadingMsg: [],
  downloadMsg: [],
...
},
{
  ...
  key: 'days',
  jsFileName: 'days',
  url: 'https://comic-days.com/episode/*',
  originUrl: 'comic-days.com',
  regex: /^https:\/\/comic-days\.com\/episode\/.*/,
  name: "コミックDAYS",
  supportMsg: [],
  loadingMsg: [],
  downloadMsg: [],
  ...
  key: 'gardo',
  jsFileName: 'gardo',
  url: 'https://comic-gardo.com/episode/*',
  originUrl: 'comic-gardo.com',
  regex: /^https:\/\/comic-gardo\.com\/episode\/.*/,
  name: "コミックガルド",
  supportMsg: [],
  loadingMsg: [],
  downloadMsg: [],
  ...
  key: 'walker',
  jsFileName: 'walker',
  url: 'https://comic-walker.com/detail/*/episodes/*',
  originUrl: 'comic-walker.com',
  regex: /^https:\/\/comic-walker\.com\/detail\/.*\/episodes\/.*/,
  name: "カドコミ(KADOKAWA無料)",
  supportMsg: [],
  loadingMsg: [],
  downloadMsg: [],
  loadStopMsg: "",
